...
import (
	...
	"github.com/hanzoai/status/alerting/provider"
	"github.com/hanzoai/status/alerting/provider/awsses"
	"github.com/hanzoai/status/alerting/provider/clickup"
	"github.com/hanzoai/status/alerting/provider/custom"
	"github.com/hanzoai/status/alerting/provider/datadog"
	"github.com/hanzoai/status/alerting/provider/discord"
	"github.com/hanzoai/status/alerting/provider/email"
	"github.com/hanzoai/status/alerting/provider/gitea"
	"github.com/hanzoai/status/alerting/provider/github"
	"github.com/hanzoai/status/alerting/provider/gitlab"
	"github.com/hanzoai/status/alerting/provider/googlechat"
	"github.com/hanzoai/status/alerting/provider/gotify"
	"github.com/hanzoai/status/alerting/provider/homeassistant"
	"github.com/hanzoai/status/alerting/provider/ifttt"
	"github.com/hanzoai/status/alerting/provider/ilert"
	"github.com/hanzoai/status/alerting/provider/incidentio"
	"github.com/hanzoai/status/alerting/provider/line"
	"github.com/hanzoai/status/alerting/provider/matrix"
	"github.com/hanzoai/status/alerting/provider/mattermost"
	"github.com/hanzoai/status/alerting/provider/messagebird"
	"github.com/hanzoai/status/alerting/provider/n8n"
	"github.com/hanzoai/status/alerting/provider/newrelic"
	"github.com/hanzoai/status/alerting/provider/ntfy"
	"github.com/hanzoai/status/alerting/provider/opsgenie"
	"github.com/hanzoai/status/alerting/provider/pagerduty"
	"github.com/hanzoai/status/alerting/provider/plivo"
	"github.com/hanzoai/status/alerting/provider/pushover"
	"github.com/hanzoai/status/alerting/provider/rocketchat"
	"github.com/hanzoai/status/alerting/provider/sendgrid"
	"github.com/hanzoai/status/alerting/provider/signal"
	"github.com/hanzoai/status/alerting/provider/signl4"
	"github.com/hanzoai/status/alerting/provider/slack"
	"github.com/hanzoai/status/alerting/provider/splunk"
	"github.com/hanzoai/status/alerting/provider/squadcast"
	"github.com/hanzoai/status/alerting/provider/teams"
	"github.com/hanzoai/status/alerting/provider/teamsworkflows"
	"github.com/hanzoai/status/alerting/provider/telegram"
	"github.com/hanzoai/status/alerting/provider/twilio"
	"github.com/hanzoai/status/alerting/provider/vonage"
	"github.com/hanzoai/status/alerting/provider/webex"
	"github.com/hanzoai/status/alerting/provider/zapier"
	"github.com/hanzoai/status/alerting/provider/zulip"
