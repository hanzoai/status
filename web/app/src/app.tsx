        ...
        <div className="w-full max-w-md rounded-lg border border-border bg-card">
          ...
          <div className="px-6 pb-6">
            ...
            <a
              ...
              className="flex h-11 w-full items-center justify-center gap-2 rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90"
            >
              {oidcLoading ? (
                <Loading size="xs" />
              ) : (
