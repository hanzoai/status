            ...
            <div className="space-y-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  {suite.group && <div className="mt-2 text-muted-foreground">Group: {suite.group}</div>}
                </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="rounded-lg border border-border bg-card">
                  <div className="px-6 pb-2 pt-6"><p className="text-sm font-medium text-muted-foreground">Current Status</p></div>
                  <div className="px-6 pb-6"><div className="text-2xl font-bold">{healthStatus === 'healthy' ? 'All Passing' : 'Failures Detected'}</div></div>
                </div>
                <div className="rounded-lg border border-border bg-card">
                  <div className="px-6 pb-2 pt-6"><p className="text-sm font-medium text-muted-foreground">Last Check</p></div>
