                      ...
                      {uncollapsedGroups.has(group) && (
                        <div className="p-4">
                          {items.suites.length > 0 && (
                            <div className="mb-4">
                              <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground/70">Suites</h3>
                          ...
                          {items.endpoints.length > 0 && (
                            <div>
                              {items.suites.length > 0 && (
                                <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground/70">Endpoints</h3>
                              )}
                              <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
